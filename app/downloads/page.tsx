...
const ROWS: Row[] = [
  {
    ...
    items: [
      ...
      { name: "LinkedIn logo · on cobalt",      format: "PNG · 1200×1200", size: "78 KB", href: "/downloads/trainovate-logo-linkedin-cobalt-1200.png" },
      { name: "LinkedIn logo · on white",       format: "PNG · 1200×1200", size: "70 KB", href: "/downloads/trainovate-logo-linkedin-white-1200.png" },
      { name: "LinkedIn logo · on ink",         format: "PNG · 1200×1200", size: "84 KB", href: "/downloads/trainovate-logo-linkedin-ink-1200.png" },
